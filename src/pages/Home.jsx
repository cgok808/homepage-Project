  ...
  return (
    <Wallpaper>
      <div className='flex flex-col justify-center items-center gap-8 md:flex-row md:justify-around min-h-screen p-4 box-border overflow-y-auto'>
        {/* Left side */}
        <div className='flex flex-col justify-center md:items-center md:h-full mb-8 md:mb-0 gap-8'>
          <SiteSearch />
          <ToDoList />
        </div>

        {/* Right side */}
        <div className='flex flex-col justify-center items-center gap-[2rem] transform-gpu will-change-transform'>
